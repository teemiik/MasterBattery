package com.masterclean.system.app.Fragments;
...
import com.masterclean.system.app.MainActivity;
import com.masterclean.system.app.ModeNormal;
import com.masterclean.system.app.SavingPowerPopUp;
import com.masterclean.system.app.UltraPopUp;
        ...
        try {
            ...
            powersaving.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), SavingPowerPopUp.class);
            ...
            ultrasaving.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), UltraPopUp.class);
            ...
            normal.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), ModeNormal.class);
                    startActivity(i);
                }
            });
