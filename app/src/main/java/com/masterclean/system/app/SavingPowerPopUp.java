...
import com.masterclean.system.app.Classes.ItemPower;
import jp.wasabeef.recyclerview.animators.SlideInLeftAnimator;
import jp.wasabeef.recyclerview.animators.SlideInUpAnimator;

public class SavingPowerPopUp extends Activity{
...
//        (+10 h 30m)
        ...
        applied.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(getApplicationContext(),SavingPowerComplition.class);
                startActivity(i);
