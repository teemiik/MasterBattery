...
public class SaverBatteryBlack extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(check%2==0) {
                    ...
                    disable.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent i=new Intent(SaverBatteryBlack.this,ModeNormal.class);
                            startActivity(i);
        ...
        alaram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i=new Intent(SaverBatteryBlack.this,Pick_Apps.class);
                    startActivity(i);
                }
