...
public class UltraApplying extends Activity {
...
//                ramperct.setText(ran3.nextInt(40) + 20+"%");
                ...
                check=1;
                youDesirePermissionCode(UltraApplying.this);
...
//            Toast.makeText(getApplicationContext(),"onActivityResult",Toast.LENGTH_LONG).show();
            //do your code
            SavingPowerComplition.setAutoOrientationEnabled(getApplicationContext(), false);
            ...
            Intent i=new Intent(UltraApplying.this,SaverBatteryBlack.class);
            startActivity(i);
            finish();
        }
    }
